    ...
    <footer id="contact" className="relative px-5 pb-10 pt-24">
      <div className="mx-auto max-w-6xl border-t border-white/10 pt-12">
        <div className="grid gap-10 sm:grid-cols-[1.4fr_1fr_1fr]">
          ...
          <FooterColumn title="Company" links={[["Support & contact", "mailto:hello@kelo-care.com"], ["Privacy", "/privacy"], ["Terms", "/terms"], ["Delete account", "/delete-account"], ["Accessibility", "/accessibility"]]} />
        </div>
