...
export function LivingCard({ children, className }: LivingCardProps) {
  return (
    <div
      className={cn(
        "living-card group relative min-w-0 overflow-hidden rounded-[2rem] border border-white/20 bg-white/[0.075] shadow-[0_22px_70px_-34px_rgba(4,7,28,.9),inset_0_1px_0_rgba(255,255,255,.18)] backdrop-blur-md",
        "transition-[transform,border-color,background-color,box-shadow] duration-300 hover:border-kelo-300/45 hover:bg-white/[0.11] hover:shadow-[0_24px_70px_-34px_rgba(37,99,235,.62),inset_0_1px_0_rgba(255,255,255,.22)]",
    ...
    >
      ...
      <div className="relative min-w-0 [overflow-wrap:anywhere]">{children}</div>
    </div>
  );
}
